...
excerpt: Aneb přítel na telefonu.
icon: mdi:phone
color: cyan
...
content_blocks:
  - type: text
    content: |-
      Možnost telefonické konzultace pro rychlou radu v případě menších zdravotních potíží nebo nejasností.

  - type: features_list
    heading: Kdy zavolat
    items:
      - Nejste si jisti, zda je nutná osobní návštěva
      - Potřebujete radu při lehčích potížích
      - Máte dotazy k léčbě nebo medikaci
      - Chcete konzultovat výsledky vyšetření
      - Řešíte běžné zdravotní problémy
