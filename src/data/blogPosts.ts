...
export const blogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    excerpt: 'Jak rozpoznat alergii u dítěte, nejčastější alergeny a co dělat v případě alergické reakce. Praktický návod pro rodiče.',
  ...
  },
  {
    ...
    excerpt: 'Proč je kvalitní spánek pro děti tak důležitý? Kolik hodin spánku vaše dítě potřebuje a jak vytvořit zdravé spánkové návyky.',
  ...
  },
  {
    ...
    excerpt: 'Přehled nejčastějších onemocnění, která postihují děti v zimě. Jak jim předcházet a kdy vyhledat lékařskou pomoc.',
